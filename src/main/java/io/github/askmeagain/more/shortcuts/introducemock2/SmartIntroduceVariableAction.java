...
import io.github.askmeagain.more.shortcuts.introducemock.exceptions.ExpressionListNotFoundException;
...
public class SmartIntroduceVariableAction extends AnAction {
  ...
  private PsiExpressionList findPsiExpressionList(PsiElement element) throws ExpressionListNotFoundException {
